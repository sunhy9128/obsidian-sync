...
| 路径错误 | 30 | 建议修正（去掉路径前缀或 .md） |
| 格式错误 | 2 | 建议修正（引号、大小写、标点、空格） |
| 缺失 | 92 | 需新建 stub 页面或修正为已存在的概念 |
...
- `[[wiki/sources/为何日韩会"股牛汇弱"]]` (2 处) — 应为 [[为何日韩会"股牛汇弱"]]（去掉路径前缀）
...
| `[[wiki/sources/为何日韩会"股牛汇弱"]]` | `[[为何日韩会"股牛汇弱"]]` | 2 |
| `[[wiki/entities/X]]` | `[[X]]` | 1 |
